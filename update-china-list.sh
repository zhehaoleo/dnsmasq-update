...
# linux 用这个
sed -i 's|114.114.114.114|223.5.5.5|g' "${CONFIG_PATH}/accelerated-domains.china.conf"
sed -i 's|114.114.114.114|223.5.5.5|g' "${CONFIG_PATH}/apple.china.conf"
sed -i 's|114.114.114.114|223.5.5.5|g' "${CONFIG_PATH}/google.china.conf"
